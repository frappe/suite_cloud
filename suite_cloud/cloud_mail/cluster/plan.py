...
from suite_cloud.cloud_mail.stalwart.client import is_write_only
...
def egress_operations(cluster: Document) -> list[dict]:
    """Relay routes and routing rules for egress pools; filled in by suite_cloud.cloud_mail.cluster.egress."""

    try:
        from suite_cloud.cloud_mail.cluster.egress import cluster_operations
    except ImportError:
        return []
