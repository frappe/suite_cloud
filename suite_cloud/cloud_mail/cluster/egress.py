...
GATEWAY_VARIABLES_BUILDER = "suite_cloud.cloud_mail.cluster.egress.build_gateway_variables"
...
def build_gateway_variables(context: dict) -> dict:
    from suite_cloud.cloud_mail.cluster.bootstrap import SECRET_VARIABLES
