...
from suite_infra.utils import reconnect_on_failure

if TYPE_CHECKING:
    from suite_infra.suite_infra.doctype.server_ansible_play.server_ansible_play import ServerAnsiblePlay
...
class Ansible:
    ...
    def playbook_path(self) -> str:
        ...
        return os.path.join(frappe.get_app_path("suite_infra", "deploy", "playbooks"), self.playbook)
